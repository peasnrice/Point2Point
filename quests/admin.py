...
from quests.models import Competition, GameInstance, Team, Player, QuestionsSolutionPair, Solution, GameStage, QuestType, GameInstanceConnector
...
admin.site.register(GameInstanceConnector)
